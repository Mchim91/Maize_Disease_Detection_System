...
# Define classes
CLASESS_YOLO = ['Blight', 'Rust', 'Gray Spot', 'Healthy']
...
def normalized_score(highest_confidence_score):
    if 0 <= highest_confidence_score <= 1:
        print(highest_confidence_score)
    elif highest_confidence_score > 1:
        highest_confidence_score / 100.0
        print(highest_confidence_score)
